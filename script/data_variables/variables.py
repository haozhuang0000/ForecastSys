class Variables:
    X_SELECTED=['BS_TOT_LIAB2', 'BS_TOT_ASSET', 'BS_ACCT_PAYABLE', 'BS_PREPAY',
    ...
    INDUSTRY=['INDUSTRY_SECTOR_NUM', 'INDUSTRY_GROUP_NUM', 'INDUSTRY_SUBGROUP_NUM', 'Industry_level_4_num',  'Industry_level_5_num', 'Industry_level_6_num']